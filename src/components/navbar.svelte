<script>
    import Icon from "../../public/icon.svelte";
...
<nav class="relative mx-8 mb-24 flex justify-between items-center pt-12 pb-6 font-medium md:mx-16 lg:mx-16">
    ...
    <h1 class="text-lg font-bold basis-1/2 text-center">
        <a href="/">Yolo Community Band</a>
    </h1>
    
    <div class="hidden xl:block basis-1/4">
    ...
    <div class="basis-1/4 flex flex-col justify-end items-end xl:hidden">
        <button on:click="{handleToggle}" class="space-y-1 cursor-pointer z-50">
